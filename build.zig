...
pub fn build(b: *std.Build) void {
    ...
    version_options.addOption([]const u8, "version", package_version);
    const version_options_mod = version_options.createModule();
    ...
    const makai_cli_module = b.createModule(.{
        ...
        .optimize = optimize,
        .imports = &.{
            .{ .name = "build_options", .module = version_options_mod },
            .{ .name = "ai_types", .module = ai_types_mod },
            .{ .name = "api_registry", .module = api_registry_mod },
            .{ .name = "event_stream", .module = event_stream_mod },
            .{ .name = "agent_loop", .module = agent_loop_mod },
