...
type ActiveAgentSession = {
  ...
  nextSequence: number;
  stopped?: boolean;
  /** Whether this attempt's session id was generated by this client (not caller-supplied). */
...
class StdioAgentApi implements MakaiAgentApi {
  ...
  private async runOnce(request: AgentRunRequest, effectivePolicy: RunOptions["auth_retry_policy"] | undefined, signal?: AbortSignal, activeSession?: ActiveAgentSession): Promise<AgentRunResponse> {
    ...
    if (activeSession) {
      ...
      activeSession.idClientGenerated = request.options?.session_id === undefined;
